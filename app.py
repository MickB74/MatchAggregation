...
tab_guide, tab_load_gen, tab_load, tab_gen, tab_fin, tab_offtake, tab_scenario, tab_dl = st.tabs(["1\\. Start Here", "2\\. Load Profile Generator", "3\\. Load Setup", "4\\. Generation Profile", "5\\. Financial Analysis", "6\\. Battery Financials", "7\\. Scenario Manager", "8\\. Download Results"])
# tab_comp removed
...
# --- Tab 2: Load Profile Generator ---
with tab_load_gen:
    st.header("2. Multi-Site 8760 Load Profile Generator")
